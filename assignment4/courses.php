...
function printListing($apiCall) {
    ...
    if (!($obj->courses == null)) {
        ...
        if($_GET['dayOfWeek'] == 'M' || $_GET['dayOfWeek'] == ''){
        ...
        if($_GET['dayOfWeek'] == 'T' || $_GET['dayOfWeek'] == ''){
            foreach ($obj->courses as $course) {
        ...
        if($_GET['dayOfWeek'] == 'W' || $_GET['dayOfWeek'] == ''){
            foreach ($obj->courses as $course) {
        ...
        if($_GET['dayOfWeek'] == 'R' || $_GET['dayOfWeek'] == ''){
            foreach ($obj->courses as $course) {
        ...
        if($_GET['dayOfWeek'] == 'F' || $_GET['dayOfWeek'] == ''){
            foreach ($obj->courses as $course) {
